...
|------|---------|-------|------------|---------------|
| Jun 2 | Instagram feed | Linen dresses launch | Stripe post | Product intro — "finally, a dress you can wear to both places" |
...
| Jun 9 | Instagram feed | Linen styling tip | Stripe post | Education — "3 ways to style the linen midi" |
...
Claude: I found 3 square-post templates in your Canva library:
  1. Boutique Stripe - Cream  (last edited Apr 2026)
...
Claude: Got it. I'll use "Boutique Stripe - Cream" for all feed posts.
